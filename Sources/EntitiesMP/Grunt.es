 ...
 ************************************************************/
  ...
  SoldierAttack(EVoid) {
    ...
    ShootProjectile(RandomProjectile(PRT_GRUNT_PROJECTILE_SOL, ERP_ENEMY), FIREPOS_SOLDIER, ANGLE3D(0, 0, 0));
  ...
  CommanderAttack(EVoid) {
    ...
    StartModelAnim(GRUNT_ANIM_FIRE, 0);
    // [Cecil] RND: Projectiles
    ShootProjectile(RandomProjectile(PRT_GRUNT_PROJECTILE_COM, ERP_ENEMY), FIREPOS_COMMANDER_DN, ANGLE3D(-20, 0, 0));
    PlaySound(m_soFire1, SOUND_FIRE, SOF_3D);

    autowait(0.035f);
    StartModelAnim(GRUNT_ANIM_FIRE, 0);
    // [Cecil] RND: Projectiles
    ShootProjectile(RandomProjectile(PRT_GRUNT_PROJECTILE_COM, ERP_ENEMY), FIREPOS_COMMANDER_DN, ANGLE3D(-10, 0, 0));
    PlaySound(m_soFire2, SOUND_FIRE, SOF_3D);

    autowait(0.035f);
    StartModelAnim(GRUNT_ANIM_FIRE, 0);
    // [Cecil] RND: Projectiles
    ShootProjectile(RandomProjectile(PRT_GRUNT_PROJECTILE_COM, ERP_ENEMY), FIREPOS_COMMANDER_DN, ANGLE3D(0, 0, 0));
    PlaySound(m_soFire1, SOUND_FIRE, SOF_3D);
